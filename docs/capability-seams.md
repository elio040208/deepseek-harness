...
| `ctx.teams` | `core` | [`team`](../packages/team/team) | - | [`tool-team`](../packages/team/tool-team) | - | Folds a whole-value teammate roster, task board, and shared skill library from the session log. |

...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TeamBoard: 'team.md',
  TeamBoardChanged: 'team.md',
  AddTeammateRequest: 'team.md',
  RemoveTeammateRequest: 'team.md',
  CreateTaskRequest: 'team.md',
  UpdateTaskRequest: 'team.md',
  ShareSkillRequest: 'team.md',
  RemoveSkillRequest: 'team.md',
